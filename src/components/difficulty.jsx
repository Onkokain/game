...
function Difficulty() {
  ...
  className={`text-center text-white text-3xl border-2 p-5 rounded-3xl px-20 italic selection:bg-transparent ${index===clicked? 'text-white/50 border-4' : 'hover:scale-110 active:scale-[95%] '}`} to={item.path}>{item.name}</Link>))}
        <Link to='/' onMouseEnter={playhover}
  onClick={playactive} className=" w-85 text-center  text-white text-3xl border-2 p-5 rounded-3xl px-20 italic hover:scale-110 active:scale-[95%] selection:bg-transparent" >Return</Link>
