...
function Start() {
    ...
    return(
        ...
        <div  className="bg-gray-800 flex flex-col gap-6 border-2 p-5 px-10 rounded-2xl border-gray-300 font-mono hover:scale-105 transition-all duration-500">
  ...
  onClick={playactive}
  className="text-white text-3xl border-2 p-5 rounded-4xl px-20 italic hover:scale-110 active:scale-[95%] selection:bg-transparent"
>
  New Game
</button> </Link>
