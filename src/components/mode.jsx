      ...
      >
        ...
        {states_mode.map((item, index) => (
          <Link
            ...
            to={item.path}
            className={`w-85 text-center text-3xl border-2 p-5 rounded-3xl px-20 italic selection:bg-transparent transition-all duration-200 ${
              index === clicked
